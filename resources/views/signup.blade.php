...
<body>
    <div class="page-wrapper bg-gra-02 p-t-100 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4" style="margin-top: -53px">
                <div class="card-body">
                    <h1 class="title"><b>Registration Form</b></h1>
                    <form method="POST" id="signup" action={{ route('signup') }} enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="file" name="profile_pic">
                                </div>
                            </div>
                        </div>
        ...
        $('#signup').validate({
            ...
            messages: {
                ...
                password: {
                    ...
                    minlength: "Password lenght should be at least 6 characters."
                },
